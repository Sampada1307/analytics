#Text Mining a speech
#import a text speech from online source and make word cloud showing theme of the speech #Ref this eg : http://www.sthda.com/english/wiki/text-mining-and-word-cloud-fundamentals-in-r-5-simple-steps-you-should-know
